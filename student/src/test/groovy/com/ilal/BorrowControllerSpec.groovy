...
class BorrowControllerSpec extends Specification implements ControllerUnitTest<BorrowController>, DomainUnitTest<Borrow> {
    ...
    void "Test the save action correctly persists"() {
        ...
        response.redirectedUrl == '/borrow/show/1'
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.borrowService = Mock(BorrowService) {
            1 * save(_ as Borrow) >> { Borrow borrow ->
                throw new ValidationException("Invalid instance", borrow.errors)
            }
        }
    ...
    void "Test the show action with a valid id"() {
        ...
        model.borrow instanceof Borrow
    }
